(function (window) {
	...
	function canReachDarkWorldGlitch() {
		return (items.moonpearl && items.boots || items.agahnim);
	}
	...
	function canReachPyramidGlitch() {
		return (canReachDarkWorld() && items.moonpearl) || (items.agahnim && items.mirror) || hasFoundEntrance(94) || hasFoundEntrance(95) || hasFoundEntrance(114) || hasFoundEntrance(115) || hasFoundEntrance(116) || hasFoundEntrance(117);
	}
	...
	//Region Connectors Overworld Glitches
	//Light World
	...
	function canReachPyramidGlitch() {
		return (canReachDarkWorldGlitch() && items.moonpearl) || (items.agahnim && items.mirror) || hasFoundEntrance(94) || hasFoundEntrance(95) || hasFoundEntrance(114) || hasFoundEntrance(115) || hasFoundEntrance(116) || hasFoundEntrance(117);
	}

	function canReachEDMNorthGlitch() {
		return items.boots;
	}

	function canReachEDMGlitch() {
		return items.boots;
	}

	function canReachHCNorthGlitch() {
		if (canReachPyramidGlitch() && items.mirror) return true;
		return items.boots;
	}

	//Dark World
	function canReachOutcastGlitch() {
		if ((items.moonpearl && items.boots) || items.mirror) return true;
		if (hasFoundEntrance(90) || hasFoundEntrance(91) || (flags.doorshuffle === 'N' && hasFoundEntrance(96)) || hasFoundEntrance(99) || hasFoundEntrance(102) || hasFoundEntrance(104) || hasFoundEntrance(105) || hasFoundEntrance(106) || hasFoundEntrance(107) || hasFoundEntrance(108) || hasFoundEntrance(109) || (hasFoundEntrance(110) && items.moonpearl && items.hammer) || hasFoundEntrance(111) || (hasFoundEntrance(112) && items.moonpearl && items.glove === 2) || hasFoundEntrance(129)) return true;
		if ((hasFoundEntrance(86) || hasFoundEntrance(87) || hasFoundEntrance(88) || hasFoundEntrance(89) || hasFoundEntrance(113) || hasFoundEntrance(119)) && items.moonpearl && (items.glove === 2 || (items.flippers && items.hookshot) || (items.glove > 0 && items.hammer && items.hookshot))) return true;
		if (canReachDarkWorldEastGlitch() && items.moonpearl && ((items.flippers || items.hammer || items.glove > 0) && items.hookshot)) return true;
		if (hasFoundEntrance(110) && items.hammer && items.boots && (items.mirror || items.book || items.bottle)) return true;
		if (hasFoundEntrance(92) && items.moonpearl && items.hookshot) return true;
		return false;
	}

	function canReachDarkWorldSouthGlitch() {
		if (canReachOutcastGlitch()) return true;
		if (hasFoundEntrance(86) || hasFoundEntrance(87) || hasFoundEntrance(88) || hasFoundEntrance(89) || hasFoundEntrance(113) || hasFoundEntrance(119)) return true;
		if (canReachDarkWorldEastGlitch() && items.moonpearl && items.hammer) return true;
		return false;
	}

	function canReachDarkWorldEastGlitch() {
		if (items.agahnim || hasFoundEntrance(94) || hasFoundEntrance(95) || hasFoundEntrance(114) || hasFoundEntrance(115) || hasFoundEntrance(116) || hasFoundEntrance(117) || ((hasFoundEntrance(86) || hasFoundEntrance(87) || hasFoundEntrance(88) || hasFoundEntrance(89) || hasFoundEntrance(113) || hasFoundEntrance(119)) && (items.hammer || items.flippers) && items.moonpearl) || (hasFoundEntrance(92) && items.moonpearl && (items.glove > 0 || items.hammer))) return true;
		if ((hasFoundEntrance(90) || hasFoundEntrance(91) || (flags.doorshuffle === 'N' && hasFoundEntrance(96)) || hasFoundEntrance(99) || hasFoundEntrance(102) || hasFoundEntrance(104) || hasFoundEntrance(105) || hasFoundEntrance(106) || hasFoundEntrance(107) || hasFoundEntrance(108) || hasFoundEntrance(109) || (hasFoundEntrance(110) && items.hammer) || hasFoundEntrance(111) || hasFoundEntrance(129)) && items.moonpearl && (items.flippers || items.hammer)) return true;
		if (canReachAndLeaveShoppingMallGlitch()) return true;
		return items.moonpearl;
	}

	function canReachDarkWorldSouthEastGlitch() {
		if (hasFoundEntrance(120) || hasFoundEntrance(121) || hasFoundEntrance(122) || ((canReachDarkWorldGlitch() || canReachDarkWorldEastGlitch() || canReachDarkWorldSouthGlitch()) && items.moonpearl)) return true;
	}

	function canReachMiseryMireGlitch() {
		if (hasFoundEntrance(123) || hasFoundEntrance(124) || hasFoundEntrance(125) || hasFoundEntrance(126) || (items.flute && items.glove === 2) || canReachDarkWorldGlitch()) return true;
	}

	function canReachDWDMNorthGlitch() {
		if (hasFoundEntrance(127) || hasFoundEntrance(131) || hasFoundEntrance(132) || hasFoundEntrance(133) || hasFoundEntrance(136) || items.moonpearl || items.hammer) return true;
		return false;
	}

	function canReachDWWDMGlitch() {
		if (canReachDWDMNorthGlitch() || hasFoundEntrance(128) || hasFoundEntrance(130)) return true;
		return false;
	}

	function canReachDWEDMGlitch() {
		if (canReachDWDMNorthGlitch() || hasFoundEntrance(134) || hasFoundEntrance(135) || (canReachEDMGlitch() && items.glove === 2 && items.moonpearl)) return true;
		return false;
	}

	function canReachAndLeaveShoppingMallGlitch() {
		if ((hasFoundEntrance(120) || hasFoundEntrance(121) || hasFoundEntrance(122)) && items.moonpearl) return true;
		return false;
	}
	...
	window.loadChestFlagsEntrance = function () {
		...
		if (flags.gametype === "I") {
			...
			window.entrances = [{ // [0]
				...
				is_available: function () {
					if (hasFoundEntrance(10)) return 'available';
					if (canReachHCNorth()) return 'possible'
				...
				is_available: function () {
					if (hasFoundEntrance(46)) return 'available';
					return ((canReachDarkWorldSouthGlitch() && items.mirror) ? 'available' : 'unavailable');
				}
			}, { // [47]
				caption: 'Two Brothers (East)',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(53)) return 'available';
					if (items.book || (items.mirror && canReachMiseryMireGlitch()) || ((hasFoundEntrance(123)) && items.mirror)) return 'available';
					return 'unavailable';
				}
			}, { // [54]
				caption: 'Desert Palace - West Entrance',
				...
				is_connector: false,
				is_available: function () {
					return (items.mirror && canReachMiseryMireGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [56]
				caption: 'Desert Palace - North Entrance',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(77)) return 'available';
					return canReachEDMNorthGlitch() ? 'available' : 'unavailable';
				}
			}, { // [78]
				caption: 'Paradox Cave (Middle)',
				is_opened: false,
				...
				is_available: function () {
					...
					return canReachEDMGlitch() ? 'available' : 'unavailable';
				}
			}, { // [79]
				caption: 'Paradox Cave (Bottom)',
				is_opened: false,
				...
				is_available: function () {
					...
					return (canReachEDMNorthGlitch() || hasFoundEntrance(80) || ((hasFoundEntrance(138) || hasFoundEntrance(139)) && items.mirror)) ? 'available' : 'unavailable';
				}
			}, { // [81]
				caption: 'Spiral Cave (Bottom)',
				is_opened: false,
				...
				is_available: function () {
					...
					return (canReachEDMNorthGlitch() || (hasFoundEntrance(137) && items.mirror)) ? 'available' : 'unavailable';
				}
			}, { // [84]
				caption: 'Fairy Ascension Cave (Entrance)',
				is_opened: false,
				...
				is_available: function () {
					...
					if (items.moonpearl && items.mirror && canReachDWEDMGlitch()) return 'available';
					return (hasFoundEntrance(83) || canReachEDMNorthGlitch() || (canReachEDMGlitch() && items.glove === 2) || (hasFoundEntrance(137) && items.mirror)) ? 'available' : 'unavailable';
				}
			}, { // [85]
				caption: 'Mimic Cave',
				is_opened: false,
				...
				is_available: function () {
					...
					if (hasFoundEntrance(138) && items.mirror) return 'available';
					if (hasFoundEntrance(139) && items.mirror) return 'available';
					return (items.mirror && canReachDWDMNorthGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [86]
				caption: 'Bomb Shop',
				is_opened: false,
				...
				is_connector: false,
				is_available: function () {
					if (canReachDarkWorldSouthGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return canReachDarkWorldSouthGlitch() ? 'available' : 'unavailable';
				}
			}, { // [87]
				caption: 'Dark Bonk Fairy',
				is_opened: false,
				...
				is_available: function () {
					...
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachDarkWorldSouthGlitch() && items.boots && items.moonpearl) ? 'available' : 'unavailable';
				}
			}, { // [88]
				caption: 'Hype Cave {bomb}',
				is_opened: false,
				...
				is_available: function () {
					...
					if ((items.bottle > 0) && items.boots && items.bomb) return 'possible';
					return (canReachDarkWorldSouthGlitch() && items.moonpearl && items.bomb) ? 'available' : 'unavailable';
				}
			}, { // [89]
				caption: 'Swamp Palace',
				is_opened: false,
				...
				is_connector: false,
				is_available: function () {
					if (canReachOutcastGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return 'unavailable';
				}
			}, { // [91]
				...
				is_available: function () {
					if (canReachOutcastGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return canReachOutcastGlitch() ? 'available' : 'unavailable';
				}
			}, { // [92]
				caption: 'Dark North East Shop',
				is_opened: false,
				...
				is_connector: false,
				is_available: function () {
					if (items.moonpearl) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
				...
				is_available: function () {
					...
					return (canReachPyramidGlitch() || canReachDarkWorldEastGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [94]
				caption: 'Fat Fairy',
				is_opened: false,
				...
				is_available: function () {
					...
					if (items.moonpearl) return 'possible';
					var crystal_count = 0;
					for (var k = 0; k < 10; k++)
						if (prizes[k] === 4 && items['boss' + k])
							crystal_count += 1;
					if (crystal_count >= 2 && (canReachPyramidGlitch() || canReachDarkWorldEastGlitch())) {
						return hasFoundLocation('bomb') ? 'available' : 'possible';
				...
				is_available: function () {
					...
					if ((hasFoundEntrance(97) || hasFoundEntrance(98)) && items.boots && items.firerod && (items.mirror || (items.bottle > 0) || items.book)) return 'possible';
					return (canReachOutcastGlitch() && items.moonpearl && items.firerod) ? (flags.doorshuffle === 'N' ? 'available' : 'possible') : 'unavailable';
				}
			}, { // [97]
				caption: 'Skull Woods - West Entrance',
				is_opened: false,
				...
				is_available: function () {
					...
					return (canReachOutcastGlitch()) ? 'possible' : 'unavailable';
				}
			}, { // [98]
				caption: 'Skull Woods - North Drop',
				is_opened: false,
				...
				is_available: function () {
					...
					return (canReachOutcastGlitch() && items.moonpearl) ? 'available' : 'unavailable';
				}
			}, { // [99]
				caption: 'Skull Woods - Central Entrance',
				is_opened: false,
				...
				is_available: function () {
					...
					if (items.mirror && items.boots) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachOutcastGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [100]
				...
				is_available: function () {
					...
					if (canReachOutcastGlitch() && (items.bottle > 0)) return 'possible';
					return (canReachOutcastGlitch() && items.moonpearl) ? 'available' : 'unavailable';
				}
			}, { // [102]
				caption: 'Skull Woods - East Entrance',
				...
				is_available: function () {
					if (hasFoundEntrance(105)) return 'available';
					if ((items.bottle > 0) && items.glove > 0) return 'possible';
					return (canReachOutcastGlitch() && items.glove > 0 && items.moonpearl) ? 'available' : 'unavailable';
				}
			}, { // [106]
				caption: 'VoO Fortune Teller',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(110)) return 'available';
					if (canReachOutcastGlitch() && items.hammer && (items.mirror || (items.bottle > 0) || items.book)) return 'possible';
					return (canReachOutcastGlitch() && items.moonpearl && items.hammer) ? 'available' : 'unavailable';
				}
			}, { // [111]
				caption: 'VoO Bombable Hut {bomb}',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(111)) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachOutcastGlitch() && items.moonpearl && items.bomb) ? 'available' : 'unavailable';
				}
			}, { // [112]
				caption: 'Hammer Peg Cave',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(112)) return 'available';
					if (canReachPyramidGlitch() && items.moonpearl && items.hammer) return 'available';
					if ((items.bottle > 0) && items.hammer) return 'possible';
					return (canReachOutcastGlitch() && items.moonpearl && items.hammer && items.glove === 2) ? 'available' : 'unavailable';
				}
			}, { // [113]
				caption: 'Arrow Game',
				is_opened: false,
				...
				is_available: function () {
					...
					if (canReachOutcastGlitch() || canReachDarkWorldSouthGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachOutcastGlitch() || canReachDarkWorldSouthGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [114]
				caption: 'Palace of Darkness',
				is_opened: false,
				...
				is_available: function () {
					...
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (items.moonpearl && canReachDarkWorldEastGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [115]
				caption: 'PoD North Hint',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(118)) return 'available';
					if (items.glove === 2) return 'available';
					if (canReachDarkWorldSouthGlitch() && items.moonpearl && items.flippers) return 'available';
					if (items.moonpearl && items.mirror) return 'possible';
					if (items.bottle > 0 && (items.glove === 2 || items.flippers || items.mirror)) return 'possible';
					return 'unavailable';
				}
			}, { // [119]
				caption: 'Dark Lake Shop',
				...
				is_available: function () {
					if (hasFoundEntrance(120)) return 'available';
					if (canReachDarkWorldSouthEastGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachDarkWorldSouthEastGlitch() && items.moonpearl && items.bomb) ? 'available' : 'unavailable';
				}
			}, { // [121]
				caption: 'Ledge Hint',
				is_opened: false,
				...
				is_available: function () {
					...
					if (canReachDarkWorldSouthEastGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachDarkWorldSouthEastGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [122]
				caption: 'Ledge Spike Cave',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(122)) return 'available';
					if (canReachDarkWorldSouthEastGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots && items.glove > 0) return 'possible';
					return (canReachDarkWorldSouthEastGlitch() && items.moonpearl && items.glove > 0) ? 'available' : 'unavailable';
				}
			}, { // [123]
				caption: 'Misery Mire',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(123)) return 'available';
					if (items.bottle > 0 && items.boots && medallionCheck(0) === 'possible') return 'possible';
					if (items.bottle > 0 && items.boots && medallionCheck(0) === 'available') return 'possible';
					if (!canReachMiseryMireGlitch() || medallionCheck(0) === 'unavailable') return 'unavailable';
				...
				is_available: function () {
					...
					if (canReachMiseryMireGlitch()) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return (canReachMiseryMireGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [125]
				caption: 'Mire Fairy',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(127)) return 'available';
					return (items.moonpearl) ? 'available' : 'possible';
				}
			}, { // [128]
				caption: 'Spike Cave',
				is_opened: false,
				...
				is_connector: false,
				is_available: function () {
					if (hasFoundEntrance(129) || items.moonpearl) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return 'unavailable';
				}
			}, { // [130]
				...
				is_connector: false,
				is_available: function () {
					if (hasFoundEntrance(131) || items.moonpearl) return 'available';
					return 'unavailable';
				}
			}, { // [132]
				caption: 'Hookshot Cave (Entrance)',
				...
				is_available: function () {
					if (hasFoundEntrance(132)) return 'available';
					return (canReachDWDMNorthGlitch() && items.moonpearl && items.glove > 0) ? 'available' : 'unavailable';
				}
			}, { // [133]
				caption: 'Superbunny Cave (Top)',
				is_opened: false,
				...
				is_available: function () {
					...
					return (canReachDWDMNorthGlitch()) ? 'available' : 'unavailable';
				}
			}, { // [134]
				caption: 'Superbunny Cave (Bottom)',
				is_opened: false,
				...
				is_available: function () {
					...
					return (canReachDWEDMGlitch() || (canReachEDMGlitch() && items.glove === 2)) ? 'available' : 'unavailable';
				}
			}, { // [135]
				caption: 'DDM Shop',
				is_opened: false,
				...
				is_available: function () {
					if (hasFoundEntrance(136)) return 'available';
					if (!items.moonpearl || medallionCheck(1) === 'unavailable') return 'unavailable';
				...
				is_connector: false,
				is_available: function () {
					if (hasFoundEntrance(137) || items.moonpearl) return 'available'
					return 'unavailable';
				}
			}, { // [138]
				caption: 'Turtle Rock Ledge - West Entrance',
				...
				is_available: function () {
					...
					if (items.moonpearl || (canReachDWEDMGlitch() & items.mirror)) return 'available';
					return 'unavailable';
				}
			}, { // [139]
				caption: 'Turtle Rock Ledge - East Entrance',
			...
			window.dungeons = [{ // [0]
				...
				is_beaten: false,
				is_beatable: function () {
					if (!canReachOutcastGlitch() || !canReachDarkWorld()) return 'unavailable';
					return window.SWBoss();
				},
				can_get_chest: function () {
					if (!canReachOutcastGlitch() || !canReachDarkWorld()) return 'unavailable';
			...
			window.chests = [{ // [0]
				...
				is_opened: false,
				is_available: function () {
					if (items.moonpearl && (canReachOutcastGlitch() || canReachDarkWorldSouthGlitch() || canReachDarkWorldEastGlitch() && items.hammer)) return 'available';
					if ((items.bottle > 0) && items.boots) return 'possible';
					return items.moonpearl && (canReachOutcastGlitch() || canReachDarkWorldSouthGlitch() || items.agahnim && items.hammer) ? 'available' : 'unavailable';
				}
			}, { // [4]
				caption: 'Gary\'s Lunchbox (save the frog first)',
				is_opened: false,
				is_available: function () {
					if (items.moonpearl && items.glove === 2) return 'available';
					if ((items.bottle > 0) && items.boots && items.glove === 2) return 'possible';
				...
				is_opened: false,
				is_available: function () {
					return items.book && items.mirror && canReachDarkWorldSouthGlitch() ?
						(items.sword >= 2 || (flags.swordmode === 'S' && items.hammer)) ? 'available' : 'information' :
						'unavailable';
				}
			}, { // [8]
				...
				is_opened: false,
				is_available: function () {
					if ((canReachDarkWorldEastGlitch() || hasFoundEntrance(92)) && items.moonpearl && items.glove) return 'available';
				...
				is_opened: false,
				is_available: function () {
					return items.lantern ? 'available' : 'possible';
				}
			}, { // [11]
				caption: 'Mushroom',
				is_opened: false,
				...
				is_available: function () {
					if (items.moonpearl) return 'available';
					if (items.bottle > 0) return 'possible';
					return hasFoundEntrance(129) ? 'available' : (canReachOutcastGlitch() ? 'information' : 'unavailable');
				}
			}, { // [18]
				caption: 'Pyramid',
				is_opened: false,
				is_available: function () {
					if (items.bottle > 0) return 'possible';
					return canReachDarkWorldEastGlitch() || items.agahnim || items.moonpearl ? 'available' : 'unavailable';
				}
			}, { // [19]
				caption: 'Alec Baldwin\'s Dig-a-Thon: Pay 80 rupees',
				is_opened: false,
				is_available: function () {
					if (items.bottle > 0) return 'possible';
					return items.moonpearl && (canReachOutcastGlitch() || canReachDarkWorldSouthGlitch() || (items.agahnim && items.moonpearl && items.hammer)) ? 'available' : 'unavailable';
				}
			}, { // [20]
				caption: 'Zora River Ledge {flippers}',
				is_opened: false,
